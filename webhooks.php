			...
			if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
					...
					if($event['message']['text'] == 'สวัสดี'){
						...
						if($event['message']['text'] == '1'){
							$messages_response = 'เลือกรายการสินค้า "พิมพ์หัวข้อสินค้า" a. ครีมบำรุงหน้า 1 b. ครีมบำรุงหน้า 2  c. ครีมบำรุงหน้า 3';
						}else if($event['message']['text'] == '2'){
							$messages_response = 'โทร 191';
						}else{
							$messages_response = 'ต้องการให้ช่วยอะไรค่ะ "พิมพ์ที่ต้องการให้ช่วยเหลือ" 1.ต้องการสอบถามข้อมูลสินค้า 2.ต้องการทราบข้อมูลติดต่อภายใน';
						}
					}
